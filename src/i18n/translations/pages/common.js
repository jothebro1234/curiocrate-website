...
export const en = {
  ...
  nav: {
    ...
    kitDevelopmentItem: 'Kit Development',
    stemAdvocacyItem: 'STEM Advocacy Project',
    kitResearchInternshipItem: 'Kit Research Internship',
...
export const es = {
  ...
  nav: {
    ...
    kitDevelopmentItem: 'Desarrollo de Kits',
    stemAdvocacyItem: 'Proyecto de Promoción STEM',
    kitResearchInternshipItem: 'Pasantía de Investigación de Kits',
